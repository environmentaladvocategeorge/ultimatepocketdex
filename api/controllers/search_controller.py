...
from alchemy_models.price import Price  # Adjust if needed
from repository.postgresql_database import db
from fastapi.responses import JSONResponse

latest_price_alias = aliased(Price)
...
async def search(
    ...
    setName: Optional[str] = Query(None, description="Name of the card set to filter by (exact match)"),
